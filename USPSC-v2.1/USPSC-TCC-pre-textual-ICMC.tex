...
\titulo{Modelo para Trabalho de Conclus\~ao de Curso em \LaTeX\ utilizando a classe USPSC para o ICMC} 
...
\orientadorcorpoficha{orientador Francisco Louzada Neto}
\orientadorficha{Louzada Neto, Francisco, orient}
