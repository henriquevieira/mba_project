...
\titulo{Classificação de patentes utilizando random forest} 
\titleabstract{Classificação de patentes utilizando random forest}
...
\autorficha{Vieira, Henrique Cursino}
\autorabr{VIEIRA, H. C.}
...
\orientadorcorpoficha{orientador Nikolai Valtchev Kolev}
\orientadorficha{Valtchev Kolev, Nikolai, orient}
